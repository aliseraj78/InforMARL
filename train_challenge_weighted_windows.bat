@echo off
REM Challenge-weighted training script for InforMARL (Windows)
REM This script runs training with challenge-based reward weighting enabled
...
REM Run the challenge-weighted training with wandb disabled
